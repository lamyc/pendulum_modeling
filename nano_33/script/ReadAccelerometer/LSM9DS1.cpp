...
int LSM9DS1Class::begin(int scale)
{
  ...
  writeRegister(LSM9DS1_ADDRESS, LSM9DS1_CTRL_REG1_G, 0x00); // 119 Hz, 2000 dps, 16 Hz BW
...
int LSM9DS1Class::readAcceleration(float& x, float& y, float& z)
{
  ...
  x = data[0] * ratio / 32768.0;
  y = data[1] * ratio / 32768.0;
  z = data[2] * ratio / 32768.0;
